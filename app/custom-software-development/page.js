...
const page = () => {
  const workItems = [
    { title: "Custom Software Solution", img: "images/futured_work_img_1.jpg", category: "Software" },
    { title: "Enterprise Application", img: "images/futured_work_img_2.jpg", category: "Enterprise" },
    { title: "Business Automation", img: "images/futured_work_img_3.jpg", category: "Automation" },
  ];
          ...
          <div className="row justify-content-between">
            <div className="col-lg-6 col-md-6">
              <div className="section_heading">
                ...
                <div className="mt_30">
                  <p>
                    Transform your business operations with our custom software development services. We build tailor-made software solutions that perfectly fit your unique business needs and processes.
                  </p>
                  <p className="mt-3">
                    Our custom software solutions are designed to streamline your workflows, increase efficiency, and drive business growth. From web applications to enterprise systems, we develop software that scales with your business.
                  </p>
      ...
      <section className="tf__featured_work pt_120 xs_pt_70 pb_120 xs_pb_70">
        <div className="container">
          <div className="row justify-content-between">
            ...
            <div className="col-xl-5 col-md-6">
              <p>
                Explore our custom software development projects that showcase our expertise in building tailored business solutions.
              </p>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-4 col-md-7">
              <div className="about_text">
                ...
                <p className="mt-4">
                  Asynk is a premier technology agency specializing in custom software development, enterprise solutions, and innovative tech services. We deliver solutions that transform businesses.
                </p>
